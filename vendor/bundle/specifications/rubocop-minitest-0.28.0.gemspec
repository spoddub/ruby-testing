# -*- encoding: utf-8 -*-
# stub: rubocop-minitest 0.28.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rubocop>.freeze, [">= 1.39", "< 2.0"])
    else
      s.add_dependency(%q<rubocop>.freeze, [">= 1.39", "< 2.0"])
    end
  else
    s.add_dependency(%q<rubocop>.freeze, [">= 1.39", "< 2.0"])
  end
